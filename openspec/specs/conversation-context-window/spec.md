...
## Purpose
Limit how much conversation history is sent to the conversation model per turn via a configurable sliding window, while keeping full history persisted and visible in the UI.
